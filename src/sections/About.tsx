    ...
    >
      ...
      <Flex justify="center" className={classes.textContainer}>
        <FadeIn delay={0.5} style={{ flex: 3 }}>
          ...
          >
            I am a computer science graduated who works full time as a
            developer. My insterest in web development started in college,
            playing around with basic <Spot>HTML</Spot>, <Spot>CSS</Spot> and
            some <Spot>Javascript</Spot>. Later, I got my first job as an
            intern, where I got in touch with the first trending libraries and
            frameworks and also the full stack environment.
            <br />
            <br />
        ...
        <FadeIn delay={0.5} side="right" className={classes.picture}>
          <Image src="profile.png" alt="Chrystopher Bravos" />
        </FadeIn>
      </Flex>
      <FadeIn delay={0.6} side="bottom">
        <Flex
          w="100%"
          justify="center"
          align="center"
